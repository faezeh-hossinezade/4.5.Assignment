...
image = cv2.imread("OpenVtuber/Input/fruit_input.jpg")
image_fruit = cv2.imread("OpenVtuber/input/fruit.jpg")
...
cv2.imwrite("OpenVtuber/Output/result_lip_eyes on fruit.jpg", result)
cv2.waitKey() 